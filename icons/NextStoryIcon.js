...
function SvgNextStoryIcon(props) {
  return (
    <Svg
      width="100"
      height="100"
      ...
      {...props}
    >
      <Path fill="url(#next-story-icon_svg__pattern0)" d="M0 0h35v35H0z" />
      <Defs>
        <Pattern
          id="next-story-icon_svg__pattern0"
          patternContentUnits="objectBoundingBox"
          width={1}
          height={1}
        >
          <Use
            xlinkHref="#next-story-icon_svg__image0"
            transform="scale(.004)"
          />
        </Pattern>
        <Image
          id="next-story-icon_svg__image0"
          width={250}
          height={250}
...
export default SvgNextStoryIcon;
