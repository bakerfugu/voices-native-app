...
export const sfCrossroads = [
    ...
    {
      locationIndex: 9,
      title: "A Day on Fillmore Street",
      location: "Crossroads Trading",
      length: 2, 
      date: "Feb 2019", 
      tags: ["Fashion", "Heart-Warmer"], 
      author: "bsharp", 
      image: Images.crossroadsFillmore,
      audio: Audio.crossroadsFillmore,
      transcript: `One of my favorite days in San Francisco started out with an idea to go thrift shopping on Fillmore Street. And to be honest, I don't really know what thrift stores. I went into with my sister where she would find things that I could try on and find things that she wanted to try on. But, it was definitely right around the crossroads here. My sister picked out a few things for me including what has been for the last three years one of my favorite jackets and. Afterwards we wanted something to do before we went to dinner. We wandered south on film or for a little bit and. Came up to the Fillmore West I really famous theater and the Fillmore District of San Francisco which one is named after the other I'm not really sure but there was a line out front and it looked like there was a show that was about to start and we went up and asked what was going on and there was an artist playing there called the Lone Bellow that neither my sister. I had heard of before. We ended up buying tickets going in. Having an amazing low-key concert and then afterwards when we left walked around Fillmore Street. Till we ended up eating dinner X some Mediterranean place, that was also amazing. And while maybe the exact specifics of this day, escape me, I really treasure this as just a day that I got to spend with my sister. `,
    },
];